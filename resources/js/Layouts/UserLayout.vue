            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div v-else class="image">
                        <img :src="'/image/user/default.png'" class="img-circle elevation-2" alt="">
                    </div>
                    <div class="info">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item" @click="hideSidebar">
                            <Link :href="route('user.dashboard')" class="nav-link"
                                :class="{ 'active': $page.url.startsWith('/user/dashboard') }">
                            <i class="nav-icon fa-solid fa-dashboard"></i>
                            <p>Dashboard</p>
                            </Link>
                        </li>
                        <li class="nav-item" @click="hideSidebar">
                            <Link :href="route('user.work_zones.index')" class="nav-link"
                                :class="{ 'active': $page.url.startsWith('/user/work-zones') && $page.url !== '/user/work-zones/map' }">
                            <i class="nav-icon fa-solid fa-list"></i>
                            <p>Work zones</p>
                            </Link>
                        </li>
                        <li class="nav-item" @click="hideSidebar">
                            <Link :href="route('user.work_zones.map')" class="nav-link"
                                :class="{ 'active': $page.url.startsWith('/user/work-zones/map') }">
